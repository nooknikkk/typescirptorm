...
const list_2 = require("./models/list");
...
/** Routes go here */
router.use('/api/list', list_1.default);
router.use('/api/task', task_1.default);
/** Error handling */
router.use((req, res, next) => {
...
httpServer.listen(config_1.default.server.port, async () => {
    await list_2.List.sync();
    await task_2.Task.sync();
